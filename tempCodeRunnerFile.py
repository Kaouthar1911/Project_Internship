...
class AdminInterface:
    ...
    def upload_multiple_files(self, file_paths: List[str]):
        ...
        # Utiliser un ProcessPoolExecutor pour le traitement parallèle
        with ProcessPoolExecutor() as executor:
            # Créer une fonction partielle avec data_dir prédéfini
            ...
            for future in as_completed(future_to_file):
                filename, doc, error = future.result()
                if error:
    ...
    def reindex_documents(self):
        # Cette méthode pourrait aussi bénéficier d'une optimisation si nécessaire
